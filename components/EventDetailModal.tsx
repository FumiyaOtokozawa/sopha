    ...
    >
      <div className="relative flex flex-col max-h-[90vh]">
        {isLoading ? (
          ...
          <Fade
            in={!isLoading && !!event && !isClosing}
            timeout={isClosing ? 50 : 200}
          >
            <div
            ...
            >
              ...
              <div className="bg-gradient-to-br from-[#37373F] via-[#3D3E42] to-[#5b63d3]/50 p-4 pb-8">
                {isOwner && (
                  <div
                    className="inline-flex items-center gap-2 bg-white/20 rounded-full px-2.5 py-0.5 mb-3 animate-fade-in-up"
                ...
                {event.abbreviation && (
                  <div
                    className="text-[10px] text-gray-400 mb-1 animate-fade-in-up"
                ...
                >
                  <div className="flex items-center bg-[#37373F] rounded-lg px-2.5 py-1 shadow-sm">
                    <CalendarMonthIcon
                      className="h-3.5 w-3.5 mr-1.5 text-[#8E93DA]"
                      fontSize="small"
                    />
                    <span className="text-xs font-medium">
                      ...
                      <span className="ml-1">
                        (
                        {format(new Date(event.start_date), "E", {
                          locale: ja,
                        })}
                        )
                      </span>
              ...
              <div className="bg-[#2D2D33] -mt-4 rounded-t-2xl p-4 space-y-4 overflow-y-auto flex-1">
                ...
                >
                  <div
                    className="p-1.5 bg-[#37373F] rounded-lg flex items-center justify-center"
                    style={{ height: "36px", width: "36px" }}
                  >
                    <AccessTimeIcon
                      className="h-5 w-5 text-[#8E93DA]"
                      fontSize="small"
                    />
                  </div>
                  <div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-[#8E93DA] hover:underline text-sm font-medium block truncate"
                        title={event.url}
                      >
                        {event.url.length > 25
                          ? `${event.url.substring(0, 25)}...`
                          : event.url}
                      </a>
                    </div>
                  </div>
                ...
                {/* フッターボタン */}
                <div
                  className="sticky bottom-0 pt-4 pb-1 bg-[#2D2D33] animate-fade-in-up"
                ...
                >
                  <button
                    onClick={() => {
                      handleClose();
                      router.push(
                        `/events/eventDetailPage?event_id=${event.event_id}`
                      );
                    }}
